...
httpcaller.prototype.onStart = function() {
	...
	var defer=libQ.defer();
        ...
        var data = {
           ...
           albumart: '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png'
         };
...
httpcaller.prototype.handleBrowseUri = function(uri) {
  ...
  let action1  = this.config.get('button1Action');
  let icn1 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable1 == false ) {
    action1 = 'Not Enabled';
    icn1 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action2  = this.config.get('button2Action');
  let icn2 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable2 == false ) {
    action2 = 'NOT Enabled';
    icn2 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action3  = this.config.get('button3Action');
  let icn3 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable3 == false ) {
    action3 = 'NOT Enabled';
    icn3 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action4  = this.config.get('button4Action');
  let icn4 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable4 == false ) {
    action4 = 'NOT Enabled';
    icn4 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action5  = this.config.get('button5Action');
  let icn5 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable5 == false ) {
    action5 = 'NOT Enabled';
    icn5 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action6  = this.config.get('button6Action');
  let icn6 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable6 == false ) {
    action6 = 'NOT Enabled';
    icn6 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action7  = this.config.get('button7Action');
  let icn7 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable7 == false ) {
    action7 = 'NOT Enabled';
    icn7 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action8  = this.config.get('button8Action');
  let icn8 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable8 == false ) {
    action8 = 'NOT Enabled';
    icn8 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action9  = this.config.get('button9Action');
  let icn9 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable9 == false ) {
    action9 = 'NOT Enabled';
    icn9 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action10  = this.config.get('button10Action');
  let icn10 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable10 == false ) {
    action10 = 'NOT Enabled';
    icn10 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action11  = this.config.get('button11Action');
  let icn11 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable11 == false ) {
    action11 = 'NOT Enabled';
    icn11 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  let action12  = this.config.get('button12Action');
  let icn12 = '/albumart?sourceicon=user_interface/httpcaller/assets/http.png';
  if (enable12 == false ) {
    action12 = 'NOT Enabled';
    icn12 = '/albumart?sourceicon=user_interface/httpcaller/assets/nohttp.png';
  }
  switch (uri) {
    case 'httpcaller':
      break;
