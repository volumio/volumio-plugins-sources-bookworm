        ...
        (Object.keys(self.selectedAmp).length > 0))  {
            ...
            if (self.selectedAmp.baudRate!==undefined &&
                ...
                self.port.on('open', ()=>{
                    ...
                    if (self.debugLogging) self.logger.info('[SERIALAMPCONTROLLER] openSerialPort: Port is now open. Connecting Parser with parserOptions: ' + JSON.stringify(parserOptions));
