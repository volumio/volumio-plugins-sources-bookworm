...
//   - Ё (0x0401) maps to the same glyph as Е: there is no room for the
//     diaeresis above a full-height capital at 5x7. Lowercase ё keeps its
//     dots (they fit above the x-height form).
//   - й (0x0439) uses the lowercase и glyph rather than the contributed
//     capital-height glyph, so it renders at proper x-height mid-word. The
//     breve does not fit above an x-height glyph at 5x7, so it is omitted.
...
EXTENDED[0x0419] = [0x7C, 0x21, 0x11, 0x09, 0x7C];  // Й
...
EXTENDED[0x0439] = [0x7C, 0x20, 0x10, 0x08, 0x7C];  // й → и (breve omitted, no room at 5x7)
