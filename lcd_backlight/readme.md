...
- Check if the VEML7700 sensor is properly connected via IТВC
- Verify IТВC is enabled on your system (`sudo i2cdetect -y 1`)
...
**Note**: This plugin requires appropriate hardware (VEML7700 sensor and compatible LCD display) and may need system-level permissions to access IТВC, backlight control interfaces, and Volumio API.
