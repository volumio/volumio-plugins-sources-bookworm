...
class ServerPoller extends events_1.default {
    ...
    async testConnection(url) {
        const connectionUrl = ServerHelper_1.default.getConnectionUrl(url);
        const systemApi = (0, system_api_1.getSystemApi)(__classPrivateFieldGet(this, _ServerPoller_sdk, "f").createApi(connectionUrl));
        try {
            const systemInfo = await systemApi.getPublicSystemInfo({ timeout: 5000, timeoutErrorMessage: 'Request timeout' });
