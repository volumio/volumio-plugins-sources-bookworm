...
class ControllerJellyfin {
    ...
    getUIConfig() {
        ...
        kew_1.default.all(configPrepTasks).then((configParams) => {
            ...
            const addServerUIConf = uiconf.sections[0];
            ...
            // Add Server section
            addServerUIConf.content[3].value = JellyfinContext_1.default.getConfigValue('testServerConnBeforeAdd');
    ...
    async configAddServer(data) {
        ...
        const testBeforeAdd = data['testBeforeAdd'];
        if (testBeforeAdd && __classPrivateFieldGet(this, _ControllerJellyfin_serverPoller, "f")) {
            JellyfinContext_1.default.toast('info', JellyfinContext_1.default.getI18n('JELLYFIN_TESTING_CONN'));
            const conn = await __classPrivateFieldGet(this, _ControllerJellyfin_serverPoller, "f")?.testConnection(url);
            if (conn.error) {
                JellyfinContext_1.default.toast('error', JellyfinContext_1.default.getI18n('JELLYFIN_TEST_CONN_FAILED', conn.error));
                return;
            }
            JellyfinContext_1.default.toast('success', JellyfinContext_1.default.getI18n('JELLYFIN_TEST_CONN_OK'));
        }
        const servers = ServerHelper_1.default.getServersFromConfig();
        servers.push({
            url: host,
        ...
        JellyfinContext_1.default.setConfigValue('testServerConnBeforeAdd', testBeforeAdd);
