...
Install through Volumio plugin store (under Music Services).
...
- [Fixed] Broken streams when server has base URL ([#8](https://github.com/patrickkfkan/volumio-jellyfin/issues/8))
