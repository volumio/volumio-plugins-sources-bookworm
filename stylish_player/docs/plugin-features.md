...
1. Player animation on the left side. Multiple choices available  (Double click or double tap  on player to cycle through different ones below:
   1. Album Art
   ![Album Art](screenshots/metallic/album-cover-player.png)

   2. Vinyl with and without cover
   ![Vinyl with Cover](screenshots/metallic/vinyl-cover-player.png)
   ![Vinyl without Cover](screenshots/metallic/vinyl-player.png)
   
   3. CD with and without cover
   ![CD with Cover](screenshots/metallic/cd-cover-player.png)
   ![CD without Cover](screenshots/metallic/cd-player.png)
   
   4. Cassette
   ![Cassette](screenshots/metallic/cassette-player.png)
   
   5. Reel 2 Reel
   ![Reel to Reel](screenshots/metallic/reel-to-reel-player.png)
   
   6. Radio
   ![Radio](screenshots/metallic/web-radio-player.png)
   
   7. Globe
   ![Globe](screenshots/metallic/globe-player.png)
...
1. Digital Clock
   ![Digital Clock](screenshots/metallic/digital-clock.png)

2. Flip Clock
   ![Flip Clock](screenshots/metallic/flip-clock.png)

3. Analog Clock
   ![Analog Clock](screenshots/metallic/analog-clock.png)

4. Wallpaper (optional time and current weather) / slideshow, using Unsplash
![Wallpaper](screenshots/metallic/wallpaper.png)

5. Weather screens (current, daily, 10 day, detailed)
   ![Weather Current](screenshots/weather/current.png)
   ![Weather Daily](screenshots/weather/daily.png)
   ![Full Weather](screenshots/weather/full.png)
